...
parser.add_argument("--data_dir", default="./dataset/brats2020/MICCAI_BraTS2020_TrainingData/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./jsons/dataset_0.json", type=str, help="dataset json file")
parser.add_argument(
...
def main_worker(gpu, args):
    ...
    # )
    dice_loss = DiceCELoss(
        softmax=True, squared_pred=True, smooth_nr=args.smooth_nr, smooth_dr=args.smooth_dr
    )
