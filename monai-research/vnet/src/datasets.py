...
class TrainDataset(Dataset):
    def __init__(self, train_dir_path, transform):
        super().__init__()
...
class ValidationDataset(Dataset):
    def __init__(self, val_dir_path, transform):
        super().__init__()
    ...
    def __getitem__(self, idx):
        ...
        img_path = os.path.join(self.val_img_root, img_path)
        
        label_path = self.val_label_paths[idx]
        label_path = os.path.join(self.val_label_root, label_path)
